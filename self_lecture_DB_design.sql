...
ALTER TABLE quotes ADD author_id INT UNSIGNED NOT NULL; -- adds author_id column of 0's until assigned
...
-- TRUNCATE quotes; <--- study this and the the SET queries below
